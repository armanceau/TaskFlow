...
<div class="d-flex h-100">
	...
	<div class="w-80 h-100 py-5 pr-4">
		<div class="d-flex flex-column align-items-center w-100 h-100 border shadow-sm gap-2 br-1 w-100">
			<div class="d-flex w-100 flex-start align-items-center justify-content-between px-4 mt-4">
